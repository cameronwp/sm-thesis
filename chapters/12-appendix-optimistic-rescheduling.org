...
algorithm /does not know/ if it is safe to act, would be unacceptable. Therefore, we contribute an
...
know that the total time to schedule one event scales with $O(N \log N)$ [cite:@Hunsberger2016].
