...
TODO
- average, max (+ stdev) runtime of schedule updates by num of events
- average, max (+ stdev) runtime of observations by num of events
- average... of schedule updates mid-execution by num of executed and unexecuted events
