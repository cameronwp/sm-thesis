...
generate larger STNUs to demonstrate the soundness of variable-delay controllability checking.[fn::
The implementation of the experiments herein can be found at
